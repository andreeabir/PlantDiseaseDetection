...
class ShuffleNetV2(nn.Module):
    ...
    """
    def __init__(self, height, width, in_channel, model_scale=1.0,
                 shuffle_group=2):
        ...
        pool_size = [int(np.ceil(height / down_size)),
                     int(np.ceil(width / down_size))]
    ...
    def _select_channel_size(self, model_scale):
        ...
        elif model_scale == 2.5:
            return [(244, 4), (488, 8), (976, 4), (2048, 8)]
        else:
